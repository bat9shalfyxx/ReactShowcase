        ...
        <PageTemplate>
            <div className={styles.homePage}>
                ...
                <div className={styles.about}>
                    ...
                    <p>
                        Добро пожаловать в мое портфолио! Здесь я демонстрирую свои навыки разработки на React и
                        TypeScript. Каждый проект в этом портфолио показывает различные аспекты моей работы: от создания
                        компонентов до управления состоянием и оптимизации производительности.
                    </p>
